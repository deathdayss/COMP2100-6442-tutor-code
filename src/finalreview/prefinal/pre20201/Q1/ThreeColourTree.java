package finalreview.prefinal.pre20201.Q1;
...
public class ThreeColourTree<T extends Comparable<T>> {
	...
	public Boolean testProp2() {
		...
		return root.colour == Colour.PINK && root.testProp2();
	...
	public class Node<E extends Comparable<E>> {
		...
		public boolean testProp1() {
			if (colour != Colour.PINK && colour != Colour.PURPLE && colour != Colour.MAGENTA) {
				return false;
			}
			if (value != null) {
				return left.testProp1() && right.testProp1();
			}
			return true;
		}
		...
		public boolean testProp2() {
			if (this.value == null) {
				return colour == Colour.PINK;
			}
			return left.testProp2() && right.testProp2();
		}

		public boolean testProp3() {
			int numberOfPinkNodes = getNumberOfPinkNodes();
			return testPathPinkNodes(numberOfPinkNodes);
		}
		...
		public int getNumberOfPinkNodes() {
			int numberOfPinkNodes = 1;
			Node node = root;
			...
			return numberOfPinkNodes;
		}

		public boolean testPathPinkNodes(int numberOfPinkNodes) {
			if (colour == Colour.PINK) {
				numberOfPinkNodes--;
			}
			if (value == null) {
				return numberOfPinkNodes == 0;
			}
			return left.testPathPinkNodes(numberOfPinkNodes) && right.testPathPinkNodes(numberOfPinkNodes);
		}
